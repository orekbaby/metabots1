...
const page = () => {
  return (
    <>
      <div className="pt-24 md:pt-20 lg:pt-24 h-auto md:h-[100vh] lg:h-[100vh] md:overflow-hidden lg:overflow-hidden">
        <div className="mx-auto w-full px-0">
          <div className="flex justify-between items-start pr-0 md:pr-2 lg:pr-8">
