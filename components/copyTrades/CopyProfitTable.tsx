...
import { copyTableWallet, explorer } from '@/utils/mockData';
...
const CopyProfitTable = () => {
  ...
  const trade = mostProfit.length > 0 ? mostProfit[0] : null;
  const analysisData = trade?.trades
  console.log({
    trade
  })
// sort analysis data based on time
...
export default CopyProfitTable