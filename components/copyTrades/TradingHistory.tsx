...
const TradingHistory = () => {
  ...
  <span className="text-white text-xs font-semibold">
    {trade.to.token.symbol.substring(0, 3).toUpperCase()} {/* First three letters of the symbol */}
  </span>
</div>
