...
interface TrendingRydiumProps {
  trendingRaydium: TrendingData[]
}

const Trending:FC<TrendingRydiumProps> = ({trendingRaydium}) => {
...
// console.log({trendingRaydium})
  ...
  <TableHeader>
    <TableRow className='bg-[#0A1019] border-none outline-0'>
      ...
      <TableHead className=' text-left w-[100px] font-semibold text-[14.07px] text-[#6C757D]'>M.CAP</TableHead>
      <TableHead className='w-[100px] text-left font-semibold text-[14.07px] text-[#6C757D]'>VOL</TableHead>
      <TableHead className=' text-left w-[70px] font-semibold text-[14.07px] text-[#6C757D]'>TNXS</TableHead>
    ...
    <TableHead className='w-[100px] text-left font-semibold text-[14.07px] text-[#6C757D]'>RISK ANALYSIS</TableHead>
...
<TableRow key={index} className='border-none outline-0 '>
      ...
      <div className="flex flex-col justify-between items-center gap-1"> 
        <div
        key={index}
        className=" grid grid-cols-[52px_1fr] items-start gap-0  pb-0 px-0 h-auto">
...
<div className="w-[150px]  pl-2 md:w-[100px] lg:w-[130px]">
  <div className="flex items-center gap-1">
      ...
      <TableCell className="text-center">
                    <div className="w-[150px] md:w-[100px] lg:w-[70px] pr-8">
      ...
      <span className='text-[#FF5C5C]'>/{formatNumber(item?.pools[0]?.txns?.sells)}</span>)
        ...
        <div className="w-[50px]">
          <p className='font-semibold text-sm text-[#05A660]'>{formatPercentage(item?.events?.["1m"]?.priceChangePercentage)}</p>
        </div>
      </TableCell>
