        ...
        <TableBody>
          {limitPage?.map((row, index) => (
            <TableRow key={index} className="border-none">
              <TableCell className="flex items-center font-normal text-[9px] md:text-xs lg:text-xs pl-2 md:pl- lg:pl-2">
                {row.payment}
              </TableCell>
              ...
              <TableCell className="text-left font-normal text-[9px] md:text-xs lg:text-xs pl-6 md:pl-8 lg:pl-8">
                {row.quantity}
              </TableCell>
