        ...
        <Table className="overflow-x-hidden w-full">
          <TableHeader>
            <TableRow className="border-none bg-[#0C141F]">
              ...
              <TableHead className="w-[150px] font-normal md:font-bold lg:font-bold text-[9px] md:text-[16px] lg:text-[16px] text-right md:text-center lg:text-center pr-4 md:pr-20 lg:pr-20">
                1D Net Inflow
              </TableHead>
            </TableRow>
          </TableHeader>
