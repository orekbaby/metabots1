  ...
  return (
    <>
      <div className="w-full h-[50vh] overflow-y-auto mb-28 scrollbar-hide overflow-x-hidden">
        ...
        {/* filter */}
        <div className=" w-fit md:w-[450px] lg:w-[450px] h-[25px] md:h-[35px] lg:h-[35px] rounded-[500px] border-[#212E40] gap-2 md:gap-4 lg:gap-4 border-2 flex items-center mb-8 pr-4 md:pr-0 lg:pr-0 ">
