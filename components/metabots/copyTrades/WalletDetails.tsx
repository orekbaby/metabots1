    ...
    <>
      <div className="w-full pl-8 bg-[#0A1019] border-b-2 border-[#101720] mb-2 py-4">
        <div className="jusify-center gap-2 hidden md:flex lg:flex py-0 md:py-3 lg:py-3">
          <h2 className="font-normal text-base mb-4">Chains Supported:</h2>
        ...
        <div className="justify-between flex-col md:flex-row lg:flex-row items-start md:items-center lg:items-start pr-8 flex gap-4 md:gap-0 lg:gap-0">
          <div className="flex justify-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <MdOutlineContentCopy className="text-base md:text-[20px] lg:text-[20px]" />
            </div>
            <div className="flex justify-center items-center gap-3">
              <h3 className="font-normal text-[9px] md:text-sm lg:text-[13px]">
                Wallet Balance:{" "}
              </h3>{" "}
              <span className="font-bold text-base md:text-[24px] lg:text-[24px] text-[#FFC107]">
                $141,160,817.62
              </span>
