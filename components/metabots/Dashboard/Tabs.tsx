    ...
    <>
      <Tabs defaultValue="Transactions" className="w-full">
        <TabsList className="flex justify-between mt-0 mb-0 items-center md:justify-start lg:justify-start">
          ...
          <TabsTrigger
            className="relative w-1/3 md:w-fit lg:w-fit px-5 md:px-5 lg:px-5 font-bold
            ...
            value="NewTokens"
          >
            <div className="absolute top-0 right-5 flex items-center text-center justify-center w-[31px] h-[10.17px] py-[1.8px] rounded-[4px]  px-1 bg-[#FF3434]">
              <p className="text-[6px] font-bold text-white text-center">Hot</p>
            </div>
            New Tokens
          </TabsTrigger>
          <TabsTrigger
            className="relative w-1/3 md:w-fit lg:w-fit px-5 md:px-5 lg:px-5 
            font-bold focus-visible:border-b-[2px] data-[state=active]:border-b-[2px] data-[state=active]:text-[white] text-[#6C757D] text-[10px] md:text-sm lg:text-sm border-[#0D6EFD]"
            value="Watchlist"
          >
